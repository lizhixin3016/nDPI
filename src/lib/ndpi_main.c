...
static void ndpi_init_protocol_defaults(struct ndpi_detection_module_struct *ndpi_mod) {
  ...
  u_int16_t no_master[2] = { NDPI_PROTOCOL_NO_MASTER_PROTO, NDPI_PROTOCOL_NO_MASTER_PROTO },
    ...
    ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_ACCEPTABLE, NDPI_PROTOCOL_CEPH,
			    ...
			    ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */);
    ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_ACCEPTABLE, NDPI_PROTOCOL_MONGODB,
          no_master,
          no_master, "MongoDB", NDPI_PROTOCOL_CATEGORY_DATABASE,
					  ...
					  const NDPI_PROTOCOL_BITMASK * dbm)
{
  ...
  /* MONGODB */
  init_mongodb_dissector(ndpi_struct, &a, detection_bitmask);
